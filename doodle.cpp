...
int main_game( bool &play, bool &pause , platform p[12] , Dot &d , spring &spr , trampolin &trm, blackhole &blh  , Timer &fps )
{
...
void game_over_menu( bool &play, int score )
{
...
int main( int argc, char* args[] )
{
   srand(time(NULL));
    ...
    {	
        ...
        int score = main_game( play, pause , p , d , spr , trm , blh , fps );

        game_over_menu( play, score );
    }
